...
def fail(backend_name, reason):
    ...
    print("Failed to load backend {0}: {1}".format(backend_name, reason))
    return True
...
class BackendManager(object):
    ...
    def _load_backend(self, backend_name):
        ...
        print('trying to load backend {0}'.format(backend_name))
    ...
    def load_backend(self, backend_name):
        ...
        print('successfully loaded backend {0}'.format(backend_name))
        return backend

...
class Interface(BaseInterface):
    ...
    def IsUp(self, ifconfig=None):
        ...
        try:
            ...
            if self.verbose:
                print("SIOCGIFFLAGS failed: {0}".format(e))
            return False
...
class WiredInterface(Interface, BaseWiredInterface):
    ...
    def _eth_get_plugged_in(self):
        ...
        try:
            ...
            if self.verbose:
                print('SIOCETHTOOL failed: {0}'.format(e))
            return False
    ...
    def _mii_get_plugged_in(self):
        ...
        try:
            ...
            if self.verbose:
                print('SIOCGMIIPHY failed: {0}'.format(e))
            return False
...
class WirelessInterface(Interface, BaseWirelessInterface):
    ...
    def _connect_to_wpa_ctrl_iface(self):
        ...
        if os.path.exists(socket_loc):
            try:
                ...
                print("Couldn't open ctrl_interface: {0}".format(e))
                return None
        else:
            print("Couldn't find a wpa_supplicant ctrl_interface for iface {0}".format(self.iface))
            return None
    ...
    def ValidateAuthentication(self, auth_time):
        ...
        while (time.time() - auth_time) < MAX_TIME:
            ...
            if self.verbose:
                print('wpa_supplicant ctrl_interface status query is {0}'.format(status))
    ...
    def GetBSSID(self, iwconfig=None):
        ...
        try:
            ...
            if self.verbose:
                print("SIOCGIWAP failed: {0}".format(e))
            return ""
    ...
    def GetCurrentBitrate(self, iwconfig=None):
        ...
        try:
            ...
            if self.verbose:
                print("SIOCGIWRATE failed: {0}".format(e))
            return ""
    ...
    def _get_max_strength(self):
        ...
        try:
            ...
            if self.verbose:
                print("SIOCGIWRANGE failed: {0}".format(e))
            return None
